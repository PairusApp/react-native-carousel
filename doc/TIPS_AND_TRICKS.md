...
Here are a few other tips given by [@pcooney10](https://github.com/pcooney10) in [this thread](https://github.com/meliorence/react-native-carousel/issues/247#issuecomment-360276562):
...
Lastly, make sure to read [this note](https://github.com/meliorence/react-native-carousel#important-note-regarding-android) regarding Android and [this one](https://github.com/meliorence/react-native-carousel#important-note-regarding-ios) regarding iOS.
...
Here is an example of a working implementation (thanks [@andrewpope](https://github.com/meliorence/react-native-carousel/pull/76#issuecomment-306187425)):
...
Some users had trouble implementing navigation with the carousel (see [#83](https://github.com/meliorence/react-native-carousel/issues/83), [#146](https://github.com/meliorence/react-native-carousel/issues/146) and [#212](https://github.com/meliorence/react-native-carousel/issues/212)) because they weren't aware of methods' context.

[jordangrant](https://github.com/jordangrant) was kind enough to share [a comprehensive walkthrough](https://github.com/meliorence/react-native-carousel/issues/146#issuecomment-343933652) which is reproduced below. Kuddos to him!
...
See https://github.com/meliorence/react-native-carousel/issues/264#issuecomment-366473756
...
```javascript
"react-native-carousel": "https://github.com/meliorence/react-native-carousel#fbdb671"
```
...
In order to make it easier for everyone to find them, they are [tagged with an asterisk](https://github.com/meliorence/react-native-carousel/issues?q=is%3Aissue+label%3A%2A).

## Understanding styles

Here is a screenshot that should help you understand how each of the required variables is used.

![react-native-carousel info](https://i.imgur.com/PMi6aBd.jpg)
...
> :warning: **Make sure to read about [the recommended React Native version](https://github.com/meliorence/react-native-carousel/blob/master/doc/KNOWN_ISSUES.md#react-native-version) before migrating.**
