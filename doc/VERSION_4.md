...
![react-native-carousel mind blown](https://i.imgur.com/gdaKtSm.gif)

## 💡 Why?

So far, and because of [numerous React Native limitations](https://github.com/meliorence/react-native-carousel/issues/203), the entire plugin has basically been based on a pile of hacks and workarounds...
...
- You can find the already published beta versions by running: `npm view react-native-carousel versions --json`
- [Follow this PR closely](https://github.com/meliorence/react-native-carousel/pull/678). **This is where the discussion will take place.**
...
1. **Reducing the number of rerenders** (see [#478](https://github.com/meliorence/react-native-carousel/issues/478)). [`why-did-you-render`](https://github.com/welldone-software/why-did-you-render) is going to prove really helpful for that.
